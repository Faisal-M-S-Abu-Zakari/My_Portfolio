...
const AboutSection = () => {
  return (
    <section className="max-w-7xl mx-auto px-4 py-16 min-h-screen flex items-center">
      <div className="w-full flex flex-col gap-12">
        ...
        >
          <User
            size={50}
            className="text-neutral-900 transition-colors duration-300"
            strokeWidth={3}
          />
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
          ...
          >
            <motion.img
              ...
              className="w-full h-[550px] object-cover object-center max-w-md mx-auto rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300  grayscale"
              whileHover={{
                scale: 1.02,
